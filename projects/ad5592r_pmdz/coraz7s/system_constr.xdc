...
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports ad5592r_busy_alt_gp0]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports ad5592r_spi_cnv]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports ad5592r_resetn]
...
set_multicycle_path -setup -from [get_clocks spi_clk] -to [get_cells -hierarchical -filter NAME=~*/spi_ad5592r_execution/inst/left_aligned_reg*] 8
set_multicycle_path -hold -from [get_clocks spi_clk] -to [get_cells -hierarchical -filter NAME=~*/spi_ad5592r_execution/inst/left_aligned_reg*] 7
